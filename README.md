...
已新增一个可直接在手机浏览器（含 iPhone Safari）打开的 10×10 围棋小游戏：

- 文件：`web/go-10x10.html`
- 用法：直接双击打开，或在仓库根目录运行 `python3 -m http.server 8000` 后访问 `http://localhost:8000/web/go-10x10.html`
- 支持：落子、提子判定、自杀手禁入、停一手、悔棋、重新开始
